...
alert(Media.networkState);// 状态码显示为3，表示Audio没有找到资源路径
    ...
    mybtn.enableAutoplay = function () {
        setTimeout('three.style.display = \'block\'', 3000)
        setTimeout('    two.style.display = \'none\'', 2000)
        setTimeout('   v1.style.display=\'none\'', 4000)
        myVid.autoplay = true;
        v1.style.display = 'block'
        myVid.load();
        v1_1.style.animation = 'v1_1 2s forwards'
        back_2.style.animation = 'back_1 2s 1'
        button_1.style.animation = 'tb_1 2s 1'
    }
    var b2 = document.getElementById("b2");
    b2.myFunction = function () {
